...
module FipExtractor
  class ModelThroughYear < Resource
    attr_reader :vehicle_type, :reference_table_id, :brand_id, :model_id, :model_year, :fuel

    def initialize(vehicle_type:, reference_table_id:, brand_id:, model_id:, model_year:, fuel: nil)
